            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="space-y-6">
                    <div className="flex items-center gap-3">
                        ...
                        <h4 className="text-[10px] font-semibold uppercase tracking-[0.4em] text-[#d97757]">Active Project Matrix</h4>
                    </div>
                    <div>
                        <h3 className="text-4xl font-semibold text-[#1c1917] tracking-tighter uppercase leading-none">{projectName}</h3>
                        <p className="text-[#78716c] text-xs font-medium uppercase tracking-widest mt-3 italic font-serif">Registry: {teamName}</p>
                    </div>
                    <div className="p-6 bg-[#f7f3ed] rounded-3xl border border-[#e5dec9] flex items-center gap-6">
                        ...
                        <div>
                            <p className="text-[9px] font-medium text-[#78716c] uppercase tracking-[0.3em]">Operational Lead</p>
                            <p className="text-lg font-semibold text-[#1c1917] uppercase tracking-tight">{adminName}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    <div className="flex items-center gap-3">
                        <span className="w-6 h-px bg-[#d97757]"></span>
                        <h4 className="text-[10px] font-semibold uppercase tracking-[0.4em] text-[#d97757]">Assigned Operators</h4>
                    </div>
                    <div className="grid grid-cols-1 gap-3">
                        {members.filter(m => m !== null).map((member) => (
                            <div key={member.id} className="flex items-center gap-4 p-4 hover:bg-[#f7f3ed]/50 rounded-2xl transition-all border border-transparent hover:border-[#e5dec9]">
                                ...
                                <div>
                                    <p className="text-sm font-semibold text-[#1c1917] uppercase tracking-tight">{member.full_name}</p>
                                    <p className="text-[9px] font-medium text-[#78716c] uppercase tracking-widest">{member.role}</p>
                                </div>
                            </div>
                        ))}
                    </div>
