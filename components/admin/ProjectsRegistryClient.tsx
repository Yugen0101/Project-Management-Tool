    ...
    return (
        <div className="space-y-10 pb-20 animate-in fade-in duration-1000">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                <div className="space-y-3">
                    ...
                    <h1 className="text-5xl font-semibold text-[#1c1917] tracking-tighter uppercase leading-none">
                        Projects <span className="text-accent-500">Registry</span>
                    </h1>
                </div>
                <div className="flex items-center gap-4">
                    ...
                    <button className="p-4 bg-white border border-[#e5dec9] rounded-2xl text-[#1c1917]/20 hover:text-[#1c1917] transition-all">
                ...
                <div className="flex items-center gap-2 overflow-x-auto pb-px">
                    {tabs.map(t => (
                        <button
                            ...
                            className={`px-6 py-4 text-[10px] font-medium uppercase tracking-widest transition-all relative ${tab === t.id ? 'text-[#1c1917]' : 'text-[#1c1917]/30 hover:text-[#1c1917]/60'}`}
                        >
                            {t.label}
                            {tab === t.id && (
            ...
            <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2 px-4 py-2 bg-white border border-[#e5dec9] rounded-xl text-[10px] font-medium uppercase tracking-widest text-[#1c1917]/40">
