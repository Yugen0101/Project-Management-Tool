...
export default function KanbanBoard({
    ...
    return (
        <div className="flex flex-col h-full gap-6 relative">
            {/* Error Alert */}
            {error && (
                <div className="absolute top-4 left-1/2 -translate-x-1/2 z-[100] bg-[#c85a54] text-white px-8 py-4 rounded-2xl shadow-2xl shadow-[#c85a54]/30 font-medium uppercase tracking-[0.2em] text-[10px] flex items-center gap-4 animate-in slide-in-from-top-4 fade-in duration-500 border border-white/20">
