...
function TeamLoginForm() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#1c1917] relative overflow-hidden px-6 selection:bg-[#d97757] selection:text-white">
            ...
            <div className="absolute top-[-5%] right-[-5%] w-64 h-64 bg-[#d97757]/10 rounded-3xl rotate-12 -z-10 text-white font-bold text-8xl flex items-center justify-center">T</div>

            <div className="w-full max-w-md relative z-10">
                <div className="card shadow-2xl shadow-black/50 border-[#44403c] bg-[#292524] text-[#f7f3ed]">
                    <div className="text-center mb-10">
                        <div className="relative w-32 h-32 mx-auto mb-4 grayscale invert">
                            <TaskForgeLogo size="xl" />
                        </div>
                        <h1 className="text-3xl font-bold text-white mb-2 tracking-tighter uppercase italic">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        {error && (
                            <div className="bg-red-950/50 border border-red-500/50 text-red-200 px-4 py-3 rounded-xl text-[10px] font-bold uppercase tracking-wider text-center">
                                {error}
                            </div>
                        )}

                        <div className="space-y-2">
                            <label htmlFor="email" className="block text-[10px] font-bold uppercase tracking-[0.3em] text-white/40 ml-1">
                                Team Email
                            </label>
                            <input
                                id="email"
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center ml-1">
                                <label htmlFor="password" className="block text-[10px] font-bold uppercase tracking-[0.3em] text-white/40">
                                    Access Key
                                </label>
                            </div>
                            <input
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-5 bg-[#d97757] text-white rounded-2xl disabled:opacity-50 disabled:cursor-not-allowed text-[11px] font-bold uppercase tracking-[0.3em] hover:bg-[#c26242] transition-all active:scale-[0.98]"
                        >
                    ...
                    <div className="mt-8 text-center border-t border-white/5 pt-8">
                        <p className="text-[9px] font-bold text-white/20 uppercase tracking-[0.4em]">Operational Protocol v.2.7-TM</p>
                    </div>
                </div>

                <div className="mt-8 text-center text-[10px] font-bold uppercase tracking-[0.3em] text-white/20">
